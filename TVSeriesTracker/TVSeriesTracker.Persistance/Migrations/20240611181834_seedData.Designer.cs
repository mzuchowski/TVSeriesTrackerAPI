...
namespace TVSeriesTracker.Persistance.Migrations
{
    ...
    [Migration("20240611181834_seedData")]
            ...
            modelBuilder.Entity("TVSeriesTracker.Domain.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 6, 11, 20, 18, 34, 180, DateTimeKind.Local).AddTicks(319),
            ...
            modelBuilder.Entity("TVSeriesTracker.Domain.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 6, 11, 20, 18, 34, 180, DateTimeKind.Local).AddTicks(1730),
                            CreatedBy = "Michał Zuchowski",
                            DirectorId = 1,
                            StatusId = 1
                        },
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2024, 6, 11, 20, 18, 34, 180, DateTimeKind.Local).AddTicks(2155),
                            CreatedBy = "Michał Zuchowski",
                            DirectorId = 1,
                            StatusId = 1
                        });
